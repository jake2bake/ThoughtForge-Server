    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('readings', models.ManyToManyField(blank=True, related_name='courses', to='thoughtsapi.reading')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='thoughtsapi.topic')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='reading',
            name='topic',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='readings', to='thoughtsapi.topic'),
        ),
        migrations.CreateModel(
            name='Like',
            fields=[
